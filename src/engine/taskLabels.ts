// Backend Chinese labels for task types, used in WeCom push messages.
// Mirror of frontend/src/lib/taskLabels.ts — keep the two in sync when adding a
// type (frontend renders the plan UI; this renders the daily notification text).
